...
class TransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "update action updates category on the other transaction line" do
    post session_path, params: {email_address: @user.email_address, password: "password"}
    follow_redirect!
    ...
    assert_equal accounts(:groceries_expense).id, @other_line.account_id
    ...
    assert_response :success
    @other_line.reload
    assert_equal restaurants.account_id, @other_line.account_id,
      "Other line's account_id should be updated to match the new category's account"
  end
